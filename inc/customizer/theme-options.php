...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'kantipur-blog' ),
	'priority'   => 100,
...
$wp_customize->add_section('section_sidebar', array(    
	'title'       => __('Sidebar Options', 'kantipur-blog'),
...
$wp_customize->add_setting('page_sidebar', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'kantipur_blog_sanitize_select',
	'transport'         => 'refresh',
	)
);
...
$wp_customize->add_control('page_sidebar', 
	array(		
	'label' 	=> __('Page Sidebar', 'kantipur-blog'),
	'section' 	=> 'section_sidebar',
	'settings'  => 'page_sidebar',
	'type' 		=> 'radio',
	'choices' 	=> array(		
		'left-sidebar' 	=> __( 'Left Sidebar', 'kantipur-blog'),						
		'right-sidebar' => __( 'Right Sidebar', 'kantipur-blog'),	
		'no-sidebar' 	=> __( 'No Sidebar', 'kantipur-blog'),	
		),	
	)
);
...
$wp_customize->add_control('single_post_sidebar', 
	array(		
	'label' 	=> __('Single Post Sidebar', 'kantipur-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('blog_sidebar', 
	array(		
	'label' 	=> __('Blog Sidebar', 'kantipur-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('archive_sidebar', 
	array(		
	'label' 	=> __('Archive Sidebar', 'kantipur-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'kantipur-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'excerpt_length', array(
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'kantipur_blog_sanitize_number_range',
	'transport'         => 'refresh',
) );

$wp_customize->add_control( 'excerpt_length', array(
	'label'       => __( 'Excerpt Length', 'kantipur-blog' ),
	'description' => __( 'Note: Min 5 & Max 100.', 'kantipur-blog' ),
...
$wp_customize->add_section('section_post_column', 
	array(    
	'title'       => __('Post Column Option', 'kantipur-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'post_column', array(
	'label'       => __( 'Select Column Number', 'kantipur-blog' ),
	'description' => __( 'Note: Min 1 & Max 5.', 'kantipur-blog' ),
...
$wp_customize->add_setting( 'enable_frontpage_header_image', array(
	...
	'type'                => 'theme_mod',
	'capability'          => 'edit_theme_options',
	'sanitize_callback'   => 'kantipur_blog_sanitize_checkbox',
) );

$wp_customize->add_control( 'enable_frontpage_header_image', array(
	'label'       	=> esc_html__( 'Enable Header Image on Front Page', 'kantipur-blog' ),
